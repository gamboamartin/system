...
class systemTest extends test {
    ...
    public function test_form_modifica(): void
    {
        ...
        $resultado = $controler->form_modifica();
        $this->assertNotTrue(errores::$error);
    ...
    public function test_genera_form_alta(): void
    {
        errores::$error = false;
        $_SESSION['grupo_id'] = 2;
        $_SESSION['usuario_id'] = 2;
        ...
        $resultado = $controler->genera_form_alta();
        $this->assertNotTrue(errores::$error);
        $this->assertEquals("<div |class|><div |class|><input type='text' name='codigo' value='' |class| required id='codigo' placeholder='Codigo' title='Codigo' /></div></div><div |class|><div |class|><input type='text' name='codigo_bis' value='' |class| required id='codigo_bis' placeholder='Codigo BIS' title='Codigo BIS' /></div></div><div |class|><div |class|><input type='text' name='descripcion' value='' |class| required id='descripcion' placeholder='Descripcion' title='Descripcion' /></div></div><div |class|><div |class|><input type='text' name='descripcion_select' value='' |class| required id='descripcion_select' placeholder='Descripcion Select' title='Descripcion Select' /></div></div><div |class|><div |class|><input type='text' name='alias' value='' |class| required id='alias' placeholder='Alias' title='Alias' /></div></div>",$resultado);
    ...
    public function test_genera_inputs(): void
    {
        ...
        $resultado = $controler->genera_inputs();
        $this->assertNotTrue(errores::$error);
        $this->assertIsObject($resultado);
        errores::$error = false;
    ...
    public function test_include_inputs_alta(): void
    {
        errores::$error = false;
        $_SESSION['grupo_id'] = 2;
        $_SESSION['usuario_id'] = 2;
        ...
        $resultado = $controler->include_inputs_alta();
        $this->assertNotTrue(errores::$error);
        $this->assertEquals("/var/www/html/system/vendor/gamboa.martin/template_1/template/inputs/base/alta.php",$resultado);
        errores::$error = false;
    }

    public function test_include_inputs_modifica(): void
    {
        errores::$error = false;
        $_SESSION['grupo_id'] = 2;
        $_SESSION['usuario_id'] = 2;
        ...
        $resultado = $controler->include_inputs_modifica();
        $this->assertNotTrue(errores::$error);
        $this->assertEquals("/var/www/html/system/vendor/gamboa.martin/template_1/template/inputs/base/modifica.php",$resultado);
        errores::$error = false;
    }

    public function test_include_inputs_alta_seccion(): void
    {
        errores::$error = false;
        $_SESSION['grupo_id'] = 2;
        $_SESSION['usuario_id'] = 2;
        ...
        $resultado = $controler->include_inputs_alta_seccion();
        $this->assertNotTrue(errores::$error);
        $this->assertEquals("/var/www/html/system/vendor/gamboa.martin/template_1/template/inputs/base/alta.php",$resultado);
        errores::$error = false;
    ...
    public function test_inputs(): void
    {
        ...
        $keys_selects = array();
        $resultado = $controler->inputs($keys_selects);
        $this->assertNotTrue(errores::$error);
        $this->assertIsObject($resultado);
        errores::$error = false;
    }
    ...
    public function test_row_upd(): void
    {
        ...
        $resultado = $controler->row_upd($key);
        $this->assertNotTrue(errores::$error);
        $this->assertIsObject($resultado->registro_actualizado);
        errores::$error = false;
    }
    ...
    public function test_valores_default_alta(): void
    {
        errores::$error = false;
        $_SESSION['grupo_id'] = 2;
        $_SESSION['usuario_id'] = 2;
        ...
        $keys_selects= array();
        $valores_asignados_default= array();
        $resultado = $controler->valores_default_alta($keys_selects, $valores_asignados_default);
        $this->assertNotTrue(errores::$error);
        $this->assertIsArray($resultado);
        errores::$error = false;
