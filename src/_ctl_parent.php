...
class _ctl_parent extends _ctl_base {
    ...
    public function modifica(bool $header, bool $ws = false, array $keys_selects =  array(),
                             array $not_actions = array()): array|stdClass
    {
        ...
        $not_actions[] = __FUNCTION__;

        $base = $this->base_upd(keys_selects: $keys_selects, not_actions: $not_actions, params: array(),
